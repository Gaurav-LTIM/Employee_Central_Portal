		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "My Horizon",
									"targetURL": "#projectskillsappui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"projectskillsappui-display": {
								"semanticObject": "projectskillsappui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projectskillsappui",
									"url": sap.ui.require.toUrl("projectskillsappui")
								}
							}
						}
					}
